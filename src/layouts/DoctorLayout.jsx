...
import { Calendar, Clock, Users, LayoutDashboard, LogOut, Menu, X } from 'lucide-react';
...
const DoctorLayout = () => {
  ...
  const navLinks = [
    ...
    { to: '/doctor/schedule', icon: <Clock size={20} />, label: 'My Schedule' },
  ];
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-gray-200">
        <div className="p-4 border-b border-gray-200">
          <h1 className="text-xl font-semibold text-green-600">MediCare Doctor</h1>
        </div>
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="flex items-center mb-4">
            ...
            <div className="ml-3">
              ...
              <p className="text-xs text-gray-500">{user?.email || 'doctor@hospital.com'}</p>
            </div>
          </div>
          <button
